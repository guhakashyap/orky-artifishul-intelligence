...
Dis 'ere place is for all you Mekboyz who wanna learn how to make fings *fink*. We write da kode in a way even a Grot can understand, with lots of comments explainin' all da **Kunnin'** and **Killy bitz**. We got all sorts of smart arky-tek-churs from basic **RNN Waaagh** memory boyz, to advanced **Krork-HRM** reasoning, to da ultimate **Gargant Titans** war machines! Each arky-tek-chur has its own specialty and WAAAGH energy!
